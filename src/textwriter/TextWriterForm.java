...
public class TextWriterForm extends javax.swing.JFrame {
  ...
  static String userDir = new JFileChooser().getFileSystemView().getDefaultDirectory().toString();
  /**
  ...
  public static void main(String args[]) {
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      ...
      public void run() {
          ...
          //Make a new thread that writes to the file every 15 seconds
        new Thread(() -> {
          try {
              FileWriter fw = new FileWriter(userDir + "/lines.txt");
